...
public class RetailerSignUpActivity extends AppCompatActivity {
    ...
    EditText txtFullName, txtEmail, txtPassword, txtRetypePassword, txtMobileNumber, cityEt,stateEt,pinEt, areaEt,streetEt,txtshopname;
    Button SignUp;
    FirebaseAuth mAuth;
   ...
   /* private LocationManager locationManager;
    ...
    private String name, phoneNumber,state,city,area,pin,street, email, password, confermPassword,shopname;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtshopname = findViewById(R.id.shop_name_2);
...
//        }
        ...
        mAuth.createUserWithEmailAndPassword(email, password)
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        Toast.makeText(RetailerSignUpActivity.this, ""+e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
    }
    ...
    private void saveFirebaseData() {
        ...
        user.Seller_Name = txtshopname.getText().toString();
        ...
        ref.child("Retailers").child(mAuth.getUid()).setValue(user) .addOnSuccessListener(new OnSuccessListener<Void>() {
            @Override
            public void onSuccess(Void aVoid) {
                mProgressDialog.dismiss();
                startActivity(new Intent(RetailerSignUpActivity.this, LoginActivity.class));
                finish();
            }
        })
                .addOnFailureListener(new OnFailureListener() {
