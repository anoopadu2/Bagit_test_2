...
import com.example.bagit_test_2.Orders_Page;
...
public class AdapterOrder extends RecyclerView.Adapter<AdapterOrder.HolderCart> {

    public Context context;
    public ArrayList<Order_Item> orders_list, filtered_items_list;
    public User U;
    public FireBase fb = new FireBase();
    public AdapterOrder adapter;

    public AdapterOrder(Context context, ArrayList<Order_Item> itemList, User u) {
        this.context = context;
        this.orders_list = itemList;
        this.U = u;
        this.adapter = this;
    }
    ...
    public void onBindViewHolder(@NonNull HolderCart holder, int position) {
        ...
        Order_Item order_item = orders_list.get(position);
        final String title = order_item.Item_Ordered.item.Item_Name;
        String category = order_item.Order_Status;
        //String itemImage = cart_item.getProfileImage();
        String quantity = "";
        String actualPrice = "";
        String finalPrice = Float.toString(order_item.Item_Ordered.Quantity);
        String discountPercent = Float.toString(order_item.Item_Ordered.price);
        final String productId = order_item.Order_ID;
        ...
        holder.discountPercentTv.setText(order_item.Order_Placed_On);
        ...
        try {
            ...
            String resourceName = "i" + order_item.Item_Ordered.item.Item_ID.substring(1);
        ...
        holder.deleteBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent I = new Intent(context, Order_Detail_Page.class);
                I.putExtra("Current_User_ID", ((Orders_Page)context).Current_User_ID );
                I.putExtra("Current_User_Type", ((Orders_Page)context).Current_User_Type);
                I.putExtra("Order_ID", order_item.Order_ID);
                I.putExtra("Item_ID", order_item.Item_Ordered.Item_ID);
