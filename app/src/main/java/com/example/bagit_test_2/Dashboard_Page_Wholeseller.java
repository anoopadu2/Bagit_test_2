...
public class Dashboard_Page_Wholeseller extends Custom_Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dashboard__page__wholeseller);
        ...
        fb.Load_User(u,Current_User_ID,Dashboard_Page_Wholeseller.this,progressBar,Current_User_Type);
    ...
    public void  OC_my_account(View v){
        Intent I = new Intent(Dashboard_Page_Wholeseller.this,account.class);
    ...
    public void  OC_my_orders(View v){
        Intent I = new Intent(Dashboard_Page_Wholeseller.this,Orders_Page.class);
        I.putExtra("Current_User_ID", Current_User_ID );
        I.putExtra("Current_User_Type", Current_User_Type);
        startActivity(I);
        return;
    ...
    public void  OC_purchase_Items(View v){
        ...
        Intent I = new Intent(Dashboard_Page_Wholeseller.this,Categories_Page.class);
        I.putExtra("Current_User_ID", Current_User_ID );
        I.putExtra("Current_User_Type", Current_User_Type);
    ...
    public void  OC_go_to_cart(View v){
        Intent I = new Intent(Dashboard_Page_Wholeseller.this,Cart_Page.class);
        I.putExtra("Current_User_ID", Current_User_ID );
        I.putExtra("Current_User_Type", Current_User_Type);
        I.putExtra("Purpose", "Cart");
        startActivity(I);
    ...
    public void OC_logout(View v){
        ...
        Intent I = new Intent(Dashboard_Page_Wholeseller.this,LoginActivity.class);
        I.putExtra("Current_User_ID", Current_User_ID );
        I.putExtra("Current_User_Type", Current_User_Type);
        startActivity(I);
        finish();
    ...
    public void OC_my_catalogue(View v){
        Intent I = new Intent(Dashboard_Page_Wholeseller.this,Catalogue_Page.class);
        I.putExtra("Current_User_ID", Current_User_ID );
        I.putExtra("Current_User_Type", Current_User_Type);
    ...
    public void OC_my_order_requests(View v){
        Intent I = new Intent(Dashboard_Page_Wholeseller.this,Order_Requests_Page.class);
        I.putExtra("Current_User_ID", Current_User_ID );
        I.putExtra("Current_User_Type", Current_User_Type);
        // I.putExtra("Purpose", "Catalogue");
        startActivity(I);
