...
public class Dashboard_Customer extends Custom_Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dashboard__customer);
        ...
        fb.Load_User(u,Current_User_ID,Dashboard_Customer.this,progressBar,Current_User_Type);
    ...
    public void  OC_my_account(View v){
        Intent I = new Intent(Dashboard_Customer.this,account.class);
    ...
    public void  OC_my_orders(View v){
        Intent I = new Intent(Dashboard_Customer.this,Orders_Page.class);
        I.putExtra("Current_User_ID", Current_User_ID );
        I.putExtra("Current_User_Type", Current_User_Type);
        startActivity(I);
    ...
    public void  OC_purchase_Items(View v){
        Intent I = new Intent(Dashboard_Customer.this,Categories_Page.class);
        I.putExtra("Current_User_ID", Current_User_ID );
        I.putExtra("Current_User_Type", Current_User_Type);
    ...
    public void  OC_go_to_cart(View v){
        Intent I = new Intent(Dashboard_Customer.this,Cart_Page.class);
        I.putExtra("Current_User_ID", Current_User_ID );
        I.putExtra("Current_User_Type", Current_User_Type);
        startActivity(I);
    ...
    public void OC_logout(View v){
        ...
        Toast.makeText(Dashboard_Customer.this, "Logging out user...", Toast.LENGTH_SHORT).show();
        Intent I = new Intent(Dashboard_Customer.this,LoginActivity.class);
        I.putExtra("Current_User_ID", Current_User_ID );
        I.putExtra("Current_User_Type", Current_User_Type);
        startActivity(I);
        finish();
